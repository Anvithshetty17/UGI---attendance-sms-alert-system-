    ...
    <button id="back" style="margin-left: 88.120%;width: 20%; border-radius: 10px  0px 0px 10px ;   background-color: #113f67; " type="button" onclick="goback()">Back</button>
        ...
        <form method="post" action="insert_back.php">
            ...
            <div>
                ...
                <input name="phone" type="text" id="phone" placeholder="Enter your phone number" required>
            </div>
            <div>
            ...
            <div>
                ...
                <input name="password" type="text" id="password" placeholder="Enter a password" required>
            </div>
            <br>
            <button name="addteacher" type="submit">Submit</button>
        </form>
    </div>
    <script>
        function goback(){
